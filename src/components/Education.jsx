   ...
   const education = [
      {
         ...
         note: '"Transitioned from Mechanical Engineering to Frontend Development through self-driven learning, passion for technology, and real-world project experience."'
      }
   ];
